...
{ # source : https://support.biofl_connectionductor.org/p/9135360/#9135370
  
  # get file fl_connectionnection where 'filename' is some local file with multiple data segments
  ...
  offsets <- flowCore:::readFCSheader(fl_connection)
