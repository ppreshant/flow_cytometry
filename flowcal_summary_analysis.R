...
dependancy_list <- c('6-wrappers_utilities.R',
                     "12-read_layout_fns.R",
                     '13-formatting_plot_funs.R')
# Source all the functions listed above
map(str_c('./scripts_general_fns/', dependancy_list),
    source) ;
...
reticulate::import(module = 'scripts_general_fns/g10_user_config.py', as = 'config')
